...
export default function AdvantagesSection() {
  ...
  return (
    <section id="advantages" className="py-20 md:py-32 bg-background relative">
      {/* Background */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/2 right-0 w-96 h-96 bg-muted/20 rounded-full blur-3xl" />
      </div>
