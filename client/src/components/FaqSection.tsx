...
const faqs = [
  {
    ...
    answer:
      '마인딧 코어는 정신건강 전문가가 프로그램을 보다 효율적으로 설계·운영하고, 참여자의 지속적인 경험까지 관리할 수 있도록 돕는 운영 시스템입니다.',
  },
  {
    id: 'item-2',
    question: 'Q2. 현재 정식 출시된 서비스인가요?',
    answer:
      '아직 베타 테스트 및 초기 연구·개발 단계에 있는 프로젝트입니다. 현재는 전문가 대상 사용성 테스트와 피드백 수집을 중심으로 운영되고 있습니다.',
  },
  {
    id: 'item-3',
    question: 'Q3. 어떤 전문가를 대상으로 하나요?',
    answer:
      '정신건강복지센터, 상담센터, 병원, 코치 및 정신건강 관련 프로그램을 운영하는 전문가와 기관을 대상으로 하고 있습니다.',
  },
  {
    id: 'item-4',
  ...
  },
  {
    ...
    answer:
      '랜딩페이지 하단의 베타 테스트 신청 폼에 이메일을 남겨주시면 검토 후 순차적으로 안내드릴 예정입니다. 선정된 베타 테스터에게는 추후 정식 오픈 시 할인 혜택 및 우선 사용 기회가 제공될 수 있습니다.',
  },
];
    ...
    <section id="faq" className="py-20 md:py-28">
      <div className="container max-w-4xl">
        <div className="text-center mb-10 md:mb-14">
          ...
          <div className="structural-line mx-auto w-24 mb-5" />
        </div>
